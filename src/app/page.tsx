  ...
  return (
    <div className="portfolio">
      ...
      <div className="content">
        ...
        <p>
        a front-end web developer passionate about creating interactive, user-friendly web applications. With skills in HTML, CSS, and TypeScript, I aim to build responsive and accessible websites that offer a seamless user experience. <br /> </p>
        <h2>SKILLS</h2>
